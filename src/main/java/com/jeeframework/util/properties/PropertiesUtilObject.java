...
public class PropertiesUtilObject extends Properties {
	 ...
	 *             if loading failed
	 */
	public Properties loadAllProperties(String resourceName) throws IOException {
	 ...
	 *            the name of the class path resource
	 * @param classLoader
	 *            the ClassLoader to use for loading (or <code>null</code> to
