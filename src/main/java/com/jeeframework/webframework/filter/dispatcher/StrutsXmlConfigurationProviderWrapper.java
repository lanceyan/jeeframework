 ...
 */
public class StrutsXmlConfigurationProviderWrapper extends XmlConfigurationProviderWrapper {
     ...
     */
    public StrutsXmlConfigurationProviderWrapper(boolean errorIfMissing) {
     ...
     */
    public StrutsXmlConfigurationProviderWrapper(String filename, boolean errorIfMissing, ServletContext ctx) {
