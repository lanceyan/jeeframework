...
public final class HttpServer {
    ...
    public static final String HTTP_CONFIG_FILE = "http.ini";
    ...
    private HttpServer() {
        ...
        httpProperties = new JeeProperties(HTTP_CONFIG_FILE, false);

        String path = findWebDescriptor();
    ...
    public int getHttpBindUnsecurePort() {
        return httpProperties.getIntProperty(HTTP_BIND_PORT, HTTP_BIND_PORT_DEFAULT);
    }
    ...
    private String getBindInterface() {
        String interfaceName = httpProperties.getProperty(HTTP_BIND_HOST, HTTP_BIND_HOST_DEFAULT);
...
//        }
     ...
     * @return
     */
    public String findWebDescriptor() {
        //开发环境获取到工程根目录
        ...
        ProtectionDomain protectionDomain = HttpServer.class.getProtectionDomain();//getClass 是Object类的方法
